...
namespace IdempotentFilterAttributes.Filters
{
    public class IdempotentFilter : IAsyncResourceFilter
    {
        ...
        private readonly IIdempotencyContext _idContext; // 👈 1. Inject the context here
        ...
        public async Task OnResourceExecutionAsync(ResourceExecutingContext context, ResourceExecutionDelegate next)
        {
            ...
            _logger.LogInformation("🚀 TRN ID: {id}", _idContext.LedgerId);
